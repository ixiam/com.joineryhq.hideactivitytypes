 ...
 */
class CRM_Hideactivitytypes_Upgrader_Base {

  /**
   * @var CRM_Hideactivitytypes_Upgrader_Base
   */
   ...
   *
   * ```
   * CRM_Hideactivitytypes_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Hideactivitytypes_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
